...
OP=op.o ops.o opst.o opar.o opdi.o optok.o opb.o opc.o opt.o opm.o
...
itp:itp.c s.o m.o ob.o gc.o ar.o st.o v.o gc.o nm.o di.o $(OP)
	cc $(CFLAGS) -DTESTMODULE -o $@ $< m.o ob.o s.o ar.o st.o v.o di.o gc.o nm.o       $(OP)
